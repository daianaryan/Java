                    ...
                    <form action="${pageContext.request.contextPath}/ServletControlador?accion=buscar" method="GET" enctype="multipart/form-data" autocomplete="off">                                                            
                        <div class="d-flex">
                            <div class="col-md-6 form-group label" style="font-size: 12px">   
                                ...
                                <select class="form-select label" name="nombre" id="nombre" style="font-size: 12px">
                                    <c:forEach var="libro" items="${libro}" varStatus="status">                            
    ...
    <div class="col-md-7">
        <div class="card h-75 shadow-lg">   
            <div class="card-header label">
                ...
                <div class="position-absolute top-0 end-0 me-2">
                    <button type="button" class="btn btn-outline-secondary adminInsertbtn" data-bs-toggle="modal" data-bs-target="#agregarLibroModal" style="font-size: 12px"><i class="fa fa-plus"></i></button>
                </div>
            </div>            
                ...
                <table class="table-responsive table table-striped ">                    
                    <thead>
                        <tr class="text-center">                                
                            ...
                            <th scope="col" style="font-size: 12px">Paginas</th>                          
                            <th></th>
                    ...
                    <tbody class="bodyContent">
                        <c:forEach var="libro" items="${libro}" varStatus="status">
                            <tr class="input-select justify-content-center text-center w-25">
                                ...
                                <td style="font-size: 12px">${libro.nombre}</td>
                                <td style="font-size: 12px">${libro.autor}</td>
                                <td style="font-size: 12px">${libro.cantPaginas}</td>  
                                <th></th>                                
                                <td class="d-flex py-3 justify-content-center">                               
                                    <a type="button" href="${pageContext.request.contextPath}/ServletControlador?accion=editar&idLibros=${libro.idlibros}" class="btn btn-outline-success btn"  style="font-size: 12px"><i class="far fa-edit"></i></a>                                    
                                    <a type="button" href="${pageContext.request.contextPath}/ServletControlador?accion=eliminar&idLibros=${libro.idlibros}" class="boton btn btn-outline-danger" style="font-size: 12px"><i class="far fa-trash-alt"></i></a>
                                </td>                            
                            </tr>    
                        </c:forEach>
                    </tbody>                           
